...
//Athlete 1: "Alex",   'I', 2, 5, 98.5, "Light Heavyweight"
//Athlete 2: "Bob",    'E', 3, 5, 110.6, "Heavyweight"
//Athlete 3: "Charlie",'E', 1, 0, 96.4, "Light Heavyweight"
//Athlete 4: "Danny",  'B', 0, 0, 60.5, "Flyweight"
//Athlete 5: "Edward", 'E', 2, 5, 105.7, "Heavyweight"
//Athlete 6: "Frank",  'I', 1, 5, 86.2, "Middleweight"
...
public class JudoTrainingCostCalculator {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // Press [4] to delete a registered athlete. 
            System.out.println("Press [4] Delete an Athelete");
            ...
            if (choice.equals("1")) {
                ...
                try {
                    // Enter the total number of competitions entered this month at a cost of $22.00per competition.
                ...
                do {
                    ...
                    if (privateCoachingOption.equalsIgnoreCase("yes")) {
                        try {
                            ...
                            if (noOfHours > 5) {
                                System.out.println("\n\t\tERROR: Maximum of 5 hours of private coaching is allowed.");
                            } else {
                                break;
                            }
                        } catch (NumberFormatException e) {
                ...
                if (athletes.isEmpty()) {
                    ...
                    for (int i = 0; i < athletes.size(); i++) {
                        Athletes athlete = athletes.get(i);
                        System.out.println("\n\nAthlete #" + (i + 1) + ":");
                ...
                if (athletes.isEmpty()) {
                    System.out.println("\n\t\t\t!! NO ATHLETES TO DELETE.ADD ATHLETES FIRST !!");
                } else {
                    System.out.print("\t\tEnter the athlete number to delete. Press (1 to " + athletes.size() + "): ");
                    int athleteToDelete = Integer.parseInt(scan.nextLine());

                    if (athleteToDelete >= 1 && athleteToDelete <= athletes.size()) {
                        athletes.remove(athleteToDelete - 1);
                        System.out.println("\n\t\t\t\tATHLETE #" + athleteToDelete + " HAS BEEN DELETED.");
                    } else {
                        System.out.println("\t\tInvalid athlete number. Please enter a valid athlete number.");
                    }
                }
            } else {
